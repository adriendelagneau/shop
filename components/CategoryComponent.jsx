...
const CategoryComponent = () => {
    ...
    return (
        <div div className='m-auto max-w-screen-2xl'>
            <h2 className='text-4xl uppercase font-Lemon'> look at our categories</h2>
        <div className="w-[80%]  mx-auto pb-10 flex flex-col  gap-10 xl:h-[500px] xl:flex-row items-center xl:gap-0 xl:w-[1180px] 2xl:w-[1450px]">
            ...
            <Link href={`/products?brand=nike`} className='h-[175px]  xl:transition-all xl:duration-500 cursor-pointer img3 group img w-[300px] xl:flex-1 sm:w-[450px] sm:h-[262px] lg:w-[550px] lg:h-[330px] relative'>
            ...
            <Link href={`/products?brand=nike`} className='h-[175px]  xl:transition-all xl:duration-500 cursor-pointer img4 group img w-[300px] xl:flex-1 sm:w-[450px] sm:h-[262px] lg:w-[550px] lg:h-[330px] relative'>
